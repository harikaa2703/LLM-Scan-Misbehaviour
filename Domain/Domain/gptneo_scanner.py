# -*- coding: utf-8 -*-
"""GPT-Neo scanner aligned to TinyLlama report format."""
...
class GPTNeoScanner:
    def __init__(self, model_name="EleutherAI/gpt-neo-125M", seed=42):
        self.seed = seed
        self.set_seed(seed)
    ...
    def extract_token_features(self, prompt):
        ...
        tp = np.array(token_probs, dtype=float)
        tp = np.nan_to_num(tp, nan=0.0, posinf=1.0, neginf=0.0)
